...
router.post("/register-as-Students", async (req, res) => {
...
router.post("/login-as-students", async (req, res) => {
...
router.post("/reset-password/:token", async (req, res) => {
    ...
    try {
        ...
        const id = decoded.id;
        const hashedPassword = await bcrypt.hash(password, 10);
        await Students.findByIdAndUpdate({_id:id}, {password: hashedPassword})
